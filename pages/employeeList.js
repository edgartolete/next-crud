...
export default function EmployeeList({employee, fetchEmployees}){
    ...
    return(
        <div>
            <div>{employee.first_name} { employee.last_name} | {employee.birthday} | {employee.age} 
